...
import { 
  ...
  FiSearch, 
  FiRefreshCw,
  FiUsers // L'icône pour les places
} from 'react-icons/fi';
import { FaRoute } from 'react-icons/fa';

// --- Composant interne pour gérer les actions complexes sur un trajet ---
                ...
                <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {data.docs.length > 0 ? data.docs.map(t => {
                            ...
                            const capacite = t.bus?.capacite || 0;
                            const placesOccupees = Math.max(0, capacite - t.placesDisponibles);
                            ...
                            return (
                                <div key={t._id} className="bg-white p-4 rounded-lg border hover:shadow-md transition-shadow flex flex-col justify-between">
                                    ...
                                    <div className="grid grid-cols-2 gap-x-4 text-sm text-gray-600 border-y my-3 py-2">
                                        ...
                                        <span className="col-span-2 flex items-center gap-1.5 pt-1">
                                            <FiUsers size={14} className="text-blue-500"/> 
                                            Places: <strong className="text-blue-600">{placesOccupees} / {capacite}</strong>
                                        </span>
                                    </div>
